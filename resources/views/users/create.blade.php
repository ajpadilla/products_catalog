...
@section('content')
    <div class="">
        ...
        <form id="identification-type">
            <div class="">
                <input type="text" name="name" class="" placeholder="Enter Name" id="name">
                <span id="name-error"></span>
            </div>
            <div class="">
                <input type="text" name="description" class="" placeholder="Enter description" id="description">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('#identification-type').on('submit', function(event){
            ...
            $.ajax({
                url: "/api/v1/identificationTypes",
                type: "POST",
                data:{
                    name: $('#name').val(),
